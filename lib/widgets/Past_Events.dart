...
import 'event.dart';
String name = "";
class Past_Page extends StatefulWidget {

  final String message;

  Past_Page(this.message);
  @override
  State<Past_Page> createState() => _Past_PageState();
}

class _Past_PageState extends State<Past_Page> {
                      ...
                      Center(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index)
                          {
                            ...
                            if (events[index].flag1==1 && edt.compareTo(now) < 0 && (events[index].name.toString().toLowerCase().startsWith(name.toLowerCase()) ||
