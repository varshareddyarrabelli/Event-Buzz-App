...
String name = "";
class Ongoing_Clubpage extends StatefulWidget {

  final String message;
  final String name;
  Ongoing_Clubpage(this.message,this.name);
  @override
  State<Ongoing_Clubpage> createState() => _Ongoing_ClubpageState();
}

class _Ongoing_ClubpageState extends State<Ongoing_Clubpage> {
