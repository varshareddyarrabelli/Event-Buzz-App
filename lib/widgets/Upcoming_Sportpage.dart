...
String name = "";
class Upcoming_Sportpage extends StatefulWidget {

  final String message;
  final String name;

  Upcoming_Sportpage(this.message,this.name);
  @override
  State<Upcoming_Sportpage> createState() => _Upcoming_SportpageState();
}

class _Upcoming_SportpageState extends State<Upcoming_Sportpage> {
  _getDateTime() {
    setState(() {
      now = DateTime.now();
    });
