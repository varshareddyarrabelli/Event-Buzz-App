...
import '../services/ongoing_event_list.dart';
import 'event.dart';
                    ...
                    Center(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index)
                        {
                          ...
                          if (events[index].flag1==1 && sdt.compareTo(now) < 0 && edt.compareTo(now)>0 && (events[index].name.toString().toLowerCase().startsWith(name.toLowerCase()) ||
