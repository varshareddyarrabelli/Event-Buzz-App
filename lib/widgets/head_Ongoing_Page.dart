...
import '../services/head_ongoing_eventlist.dart';
import '../services/head_ongoing_eventtile.dart';
import '../services/ongoing_eventtile.dart';
import 'createevent.dart';
import 'event.dart';
String name="";
class head_Ongoing_Page extends StatefulWidget {

  final String message;
  final String? email;
  final String name;
  head_Ongoing_Page(this.message,this.email,this.name);
  @override
  State<head_Ongoing_Page> createState() => _head_Ongoing_PageState();
}

class _head_Ongoing_PageState extends State<head_Ongoing_Page> {
