...
import 'event.dart';
String name = "";
class Past_Sportpage extends StatefulWidget {

  final String message;
  final String name;

  Past_Sportpage(this.message,this.name);
  @override
  State<Past_Sportpage> createState() => _Past_SportpageState();
}

class _Past_SportpageState extends State<Past_Sportpage> {
