...
class _AboutWidgetState extends State<AboutWidget> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: <Widget>[
        TextButton(
          ...
          onPressed: () {
    final sport1 = Feeds(
    feedback: 'This Edit request is Approved',
    ...
    create(sport1);
            ...
            final docuser1 = FirebaseFirestore.instance.collection('events').doc(widget.event.id2);
            docuser1.delete();
...
class _DenyState extends State<Deny> {
  ...
  Widget build(BuildContext context) {
    ...
    if (controllerfeedback.text.isNotEmpty) {
      ...
      final docuser1 = FirebaseFirestore.instance.collection('events').doc(
          widget.event.id);
      docuser1.delete();
      Navigator.of(context).pop();
    }
...
class Requests2 extends StatefulWidget {
  ...
  Requests2(this.event,this.message);
